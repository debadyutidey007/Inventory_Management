                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                    children: [
                                        "Select the quantity to sell. Max: ",
...
;
;
// Consistent data generation function
const getDeterministicItemData = (item)=>{
    // Simple hash function from SKU string
    const skuSeed = item.sku.split('').reduce((acc, char)=>acc + char.charCodeAt(0), 0);
    const averageDailySales = skuSeed % 19 + 1; // Range 1-20
    const leadTimeDays = skuSeed % 9 + 2; // Range 2-10
    return {
        averageDailySales,
        leadTimeDays
    };
...
function ItemsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        try {
            ...
            const storedSoldItems = localStorage.getItem("inventory-manager-sold-items");
            if (storedSoldItems) {
    ...
    // Save items and update category counts on change
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isClient) {
            localStorage.setItem("inventory-manager-items", JSON.stringify(items));
            ...
            localStorage.setItem('inventory-manager-categories', JSON.stringify(updatedCategories));
        // Note: we don't set categories state here to avoid re-renders if the object hasn't changed.
        // This can be further optimized with a deep comparison if needed.
        }
    }, [
        items,
        categories,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isClient) {
            localStorage.setItem("inventory-manager-sold-items", JSON.stringify(soldItems));
        }
    }, [
        soldItems,
        isClient
    ...
    const handleAddItem = (newItem)=>{
        ...
        const deterministicData = getDeterministicItemData(newItem);
        setItems((prevItems)=>[
                ...prevItems,
                {
                    ...newItem,
...
//# sourceMappingURL=src_030cd1d2._.js.map