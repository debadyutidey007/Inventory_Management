...
function ItemsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ItemsPage.useEffect": ()=>{
            if (isClient) {
                ...
                setCategories({
                    "ItemsPage.useEffect": (prevCategories)=>{
                        const updatedCategories = prevCategories.map({
    ...
    const handleAddItem = (newItem)=>{
        ...
        // The deterministic generation of sales/lead time will be handled by the component that uses it.
        setItems((prevItems)=>[
                ...prevItems,
                {
                    ...newItem,
                    id,
                    // Set default/placeholder values here
                    averageDailySales: 0,
                    leadTimeDays: 0
                }
            ]);
...
_s(ItemsPage, "V/39aV0Zg1CT4S2u0pW9GuRtiws=");
_c = ItemsPage;
var _c;
...
//# sourceMappingURL=src_904ea979._.js.map