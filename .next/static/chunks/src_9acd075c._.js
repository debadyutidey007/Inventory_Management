...
function ReportsPage() {
    ...
    const exportLowStockPDF = ()=>{
        ...
        const { header, addWatermark, addPageNumbers, margin, pageWidth } = setupPdfDoc(doc);
    ...
    const exportConsolidatedPDF = ()=>{
        ...
        doc.setFont('helvetica', 'bold');
        doc.setTextColor('#0C7FF2');
        doc.text("Comprehensive Inventory Analysis", margin, 60);
...
_s(ReportsPage, "1C/egYCALu2f08nMnsxoOmf718c=");
_c = ReportsPage;
var _c;
...
//# sourceMappingURL=src_9acd075c._.js.map