...
const themes = [
    {
        name: "dark",
        label: "Dark Mode",
        description: "Enable for a dark interface."
    },
    {
        name: "theme-stone",
        label: "Stone Theme",
        description: "A sleek, modern theme with neutral grays."
    },
    {
        name: "theme-orange",
        label: "Orange Theme",
    ...
    },
    {
        name: "theme-green",
        label: "Green Theme",
        description: "A calm and nature-inspired theme."
    }
];
function SettingsPage() {
    ...
    const [activeTheme, setActiveTheme] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("light");
    ...
    const handleThemeToggle = (themeName, checked)=>{
...
_s(SettingsPage, "dg7zK4bINWgRfT7+LVhs4z4Nm+g=", false, function() {
    return [
...
//# sourceMappingURL=_3e4f67a6._.js.map