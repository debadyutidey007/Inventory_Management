...
function AIAlert({ lowStockItems }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AIAlert.useEffect": ()=>{
            const fetchAlert = {
                "AIAlert.useEffect.fetchAlert": async ()=>{
                    ...
                    const alertInput = {
                        lowStockItems: lowStockItems.map({
                            "AIAlert.useEffect.fetchAlert": (item)=>({
                                    itemId: item.id,
                                    itemName: item.name,
...
_s(AIAlert, "bsKqxXdykjOVIczErla+4fdnG9Y=");
_c = AIAlert;
var _c;
...
//# sourceMappingURL=src_d4c979c6._.js.map