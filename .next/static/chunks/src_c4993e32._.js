...
;
;
function ItemsTable({ items, categories, onAddItem, onEditItem, onDeleteItem }) {
    _s();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
...
_s(ItemsTable, "1DJTOp689TZmUxVr6ym7+t7elm8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
...
function ItemsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ItemsPage.useEffect": ()=>{
            localStorage.setItem("inventopro-items", JSON.stringify(items));
        }
    }["ItemsPage.useEffect"], [
        items
    ]);
    const handleAddItem = (newItem)=>{
        // Generate random values on the client-side only to prevent hydration errors
        const id = `item-${Date.now()}`;
        const averageDailySales = Math.floor(Math.random() * 20) + 1;
        const leadTimeDays = Math.floor(Math.random() * 10) + 2;
        setItems((prevItems)=>[
                ...prevItems,
                {
                    ...newItem,
    ...
    const handleDeleteItem = (itemId)=>{
        ...
        // Also update category item counts
        const itemToDelete = items.find((i)=>i.id === itemId);
        if (itemToDelete) {
            const updatedCategories = categories.map((c)=>{
                if (c.id === itemToDelete.categoryId) {
                    return {
                        ...c,
                        itemCount: c.itemCount > 0 ? c.itemCount - 1 : 0
                    };
                }
                return c;
            });
            setCategories(updatedCategories);
            localStorage.setItem('inventopro-categories', JSON.stringify(updatedCategories));
        }
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ItemsPage.useEffect": ()=>{
            // Update category item counts whenever items change
...
_s(ItemsPage, "kUnX6JC8tlpdVutugCGos2pCzH8=");
_c = ItemsPage;
var _c;
...
//# sourceMappingURL=src_c4993e32._.js.map