        ...
        "ItemsPage.useEffect": ()=>{
            if (isClient) {
                ...
                const itemCounts = items.reduce({
                    "ItemsPage.useEffect.itemCounts": (acc, item)=>{
                        if (item.categoryId) {
                            acc[item.categoryId] = (acc[item.categoryId] || 0) + 1;
                        }
                        return acc;
                    }
                }["ItemsPage.useEffect.itemCounts"], {});
                const updatedCategories = categories.map({
                    "ItemsPage.useEffect.updatedCategories": (c)=>({
                            ...c,
                            itemCount: itemCounts[c.id] || 0
                        })
                }["ItemsPage.useEffect.updatedCategories"]);
...
_s(ItemsPage, "fKEkGy8TbOmrOatoqeEuf+YpFmA=");
_c = ItemsPage;
var _c;
...
//# sourceMappingURL=src_89263ac2._.js.map